...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($nama) && $price >= 0) {
        ...
        $stmt = $conn->prepare("INSERT INTO produk (nama_produk, price, jenis, satuan, stock) VALUES (?, ?, ?, ?, ?)");
        $stmt->bind_param('sdssi', $nama, $price, $jenis, $satuan, $stock);
        $stmt->execute();
        $stmt->close();
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="jenis" name="jenis"
                           value="<?php echo htmlspecialchars($_POST['jenis'] ?? ''); ?>"
                           placeholder="Contoh: Obat Bebas, Suplemen, Obat Keras">
                </div>
                <div class="col-md-6 mb-3">
