...
<div class="faktur-print">
    <div style="display:flex; justify-content:space-between; align-items:center; border-bottom:4px double #000; padding-bottom:10px; margin-bottom:20px;">
        ...
        <div style="text-align:right;">
            <div style="font-size:1.5rem; font-weight:bold; letter-spacing:3px; font-family:courier;">LAPORAN PRODUK</div>
    ...
    <table class="faktur-table">
        <thead>
            <tr>
                ...
                <th style="text-align:center; width:15%;">Nilai Aset</th>
            </tr>
        </thead>
        <tbody>
            <?php 
            ...
            ?>
                <tr>
                    ...
                    <td style="text-align:center;"><?php echo htmlspecialchars($row['jenis'] ?? '-'); ?></td>
                    <td style="text-align:center;"><?php echo htmlspecialchars($row['satuan'] ?? '-'); ?></td>
                    ...
                    <td style="text-align:right;">Rp <?php echo number_format($nilai_aset, 0, ',', '.'); ?></td>
                </tr>
                <?php endwhile; ?>
            <?php else: ?>
        ...
        <tfoot>
            <tr>
                ...
                <td style="text-align:center; font-weight:bold;"><?php echo isset($total_stok) ? number_format($total_stok, 0, ',', '.') : 0; ?></td>
                <td style="text-align:right; font-weight:bold;">Rp <?php echo isset($total_aset) ? number_format($total_aset, 0, ',', '.') : 0; ?></td>
            </tr>
        </tfoot>
    </table>
